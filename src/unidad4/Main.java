...
public class Main {
	...
	/**
	 * En el main es donde se ejecuta el menú
	 * donde seleccionas que quieres hacer
	 * @param args .
	 */
	...
	/**
	 * Este método se utiliza para controlar los fallos 
	 * a la hora de retirar e ingresar dinero
	 * @param cuenta1 nombre de la cuenta 
	 * @param cantidad cantidad de dinero
	 * @param opcion opción que quieras elegir
	 */
